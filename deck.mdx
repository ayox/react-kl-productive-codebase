...
<h3> Our goal is to create a <strong style={{width:"fit-content", textAlign: "center",borderBottom: '10px solid',
borderImageSource: "linear-gradient(120deg, #1890ff, #db18ff)",
  borderImageSlice: 5,
}}>productive</strong> codebase </h3>
...
<strong style={{width:"fit-content", textAlign: "center",borderBottom: '10px solid',
borderImageSource: "linear-gradient(120deg, #1890ff, #db18ff)",
  borderImageSlice: 5,
}}>Recap</strong>
